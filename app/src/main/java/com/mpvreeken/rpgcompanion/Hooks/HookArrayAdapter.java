...
public class HookArrayAdapter extends ArrayAdapter<Hook> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView==null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.hooks_list_item_layout, parent, false);

            holder = new AdapterViewHolder();
            holder.title_tv = convertView.findViewById(R.id.hook_list_item_title_tv);
            holder.votes_tv = convertView.findViewById(R.id.hook_list_item_votes_tv);
            holder.desc_tv = convertView.findViewById(R.id.hook_list_item_desc_tv);
            holder.upvote_btn = convertView.findViewById(R.id.hook_list_item_upvote_btn);
            holder.downvote_btn = convertView.findViewById(R.id.hook_list_item_downvote_btn);
            holder.voted=0;
            holder.tempVoted=0;
        ...
        if (hook==null) {
            ...
            holder.voted = holder.tempVoted = hook.getVoted();
            if (holder.voted == 1) {
            ...
            holder.title_tv.setText(hook.getTitle());
            holder.votes_tv.setText(hook.getListItemVotes());
