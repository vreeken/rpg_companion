        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (email.length()==0 || email.indexOf(".")==-1 || email.indexOf("@")==-1) {
                    Toast.makeText(application, "Please input a valid email address", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (password.length()==0) {
                    Toast.makeText(application, "Please input a password", Toast.LENGTH_SHORT).show();
                    return;
                }
