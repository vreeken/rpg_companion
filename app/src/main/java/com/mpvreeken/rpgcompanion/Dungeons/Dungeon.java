...
public class Dungeon extends PostObjectBase {


    public Dungeon(Context context, int position, JSONObject r) throws Exception {
        this.context=context;
        this.submissionType="dungeon";
    ...
    public SerialDungeon getSerialized() {
        return new SerialDungeon(position, id, title, description, externalLink, imageLink, upvotes, downvotes, voted);
    }

    public void updateLocal(SerialDungeon h) {
