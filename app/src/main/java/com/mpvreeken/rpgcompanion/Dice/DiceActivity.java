...
public class DiceActivity extends RPGCActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adv_rg = findViewById(R.id.dice_adv_rg);
    ...
    private void roll(String r) {
        ...
        try {
                ...
                if (s.length() > 0) {
                    if (s.contains("d")) {
                        ...
                        for (int j = 0; j < qty; j++) {
                            ...
                            if (die==20 && adv_rg.getCheckedRadioButtonId() == R.id.dice_rb_adv) {
                                int k2 = random.nextInt(die) + 1;
                                int finalk = k;
                                if (k2 > k) {
                                    if (output.length() == 0 && ops[i].equals("+")) {
                                        output.append("<font color=\"#CCCCCC\">("+k+")</font> "+k2+" ");
                                    } else {
                                        output.append(ops[i]).append(" ").append("<font color=\"#CCCCCC\">("+k+")</font> "+k2+" ");
                                    }
                                    finalk=k2;
                                }
                                else {
                                    if (output.length() == 0 && ops[i].equals("+")) {
                                        output.append(k+" <font color=\"#CCCCCC\">("+k2+")</font> ");
                                    } else {
                                        output.append(ops[i]).append(" ").append(k+" <font color=\"#CCCCCC\">("+k2+")</font> ");
                                    }
                                }
                            ...
                            else if (die==20 && adv_rg.getCheckedRadioButtonId() == R.id.dice_rb_dis) {
                                int k2 = random.nextInt(die) + 1;
                                int finalk = k;
                                if (k2 < k) {
                                    if (output.length() == 0 && ops[i].equals("+")) {
            ...
            if (split.length == 1) {
                if (r.equals("1d20") && adv_rg.getCheckedRadioButtonId() != R.id.dice_rb_normal) {
                    output_tv.setText(Html.fromHtml(output + "= " + total), TextView.BufferType.SPANNABLE);
                }
                else {
