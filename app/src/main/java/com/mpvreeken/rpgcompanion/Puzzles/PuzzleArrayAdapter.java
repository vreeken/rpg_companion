...
public class PuzzleArrayAdapter extends ArrayAdapter<Puzzle> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView==null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.puzzles_list_item_layout, parent, false);

            holder = new AdapterViewHolder();
            holder.title_tv = convertView.findViewById(R.id.puzzle_list_item_title_tv);
            holder.votes_tv = convertView.findViewById(R.id.puzzle_list_item_votes_tv);
            holder.desc_tv = convertView.findViewById(R.id.puzzle_list_item_desc_tv);
            holder.upvote_btn = convertView.findViewById(R.id.puzzle_list_item_upvote_btn);
            holder.downvote_btn = convertView.findViewById(R.id.puzzle_list_item_downvote_btn);
            holder.voted=0;
            holder.tempVoted=0;
        ...
        if (puzzle==null) {
            ...
            holder.voted = holder.tempVoted = puzzle.getVoted();
            if (holder.voted == 1) {
            ...
            holder.title_tv.setText(puzzle.getTitle());
            holder.votes_tv.setText(puzzle.getListItemVotes());
